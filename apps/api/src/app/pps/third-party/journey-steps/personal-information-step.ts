...
export class PersonalInformationStep implements IPPSStep {
  public constructor(
  ...
  public async doStep(): Promise<string | void> {
    const result = await lastValueFrom(
      this.httpService.post(
        ...
        this.ppsApiFormDataGenerator.generatePersonalInfoFormData(this.ppsApiResponseAuthenticationMetaDataExtractor.getAuthenticityToken()),
