...
export class PrecautionsStep implements IPPSStep {
  public constructor(
  ...
  public async doStep(): Promise<string | void> {
    const result = await lastValueFrom(
      this.httpService.post(
        ...
        this.ppsApiFormDataGenerator.generatePrecautionsFormData(this.ppsApiResponseAuthenticationMetaDataExtractor.getAuthenticityToken()),
