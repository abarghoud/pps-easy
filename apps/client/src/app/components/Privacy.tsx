...
export const Privacy = () => {
  return (
    <div>
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">1. Informations que nous collectons</h3>
      <p>
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">2. Utilisation de vos informations</h3>
      <p>
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">3. Protection de vos informations</h3>
      <p>
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">4. Partage de vos informations</h3>
      <p>
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">5. Vos droits</h3>
      <p>
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">6. Modifications de notre politique de confidentialité</h3>
      <p>
