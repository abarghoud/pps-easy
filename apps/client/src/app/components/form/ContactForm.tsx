...
export const ContactForm = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto min-h-[595px] flex flex-col justify- gap-2 p-6 bg-card rounded-lg shadow-md border border-border overflow-auto">
        ...
        <Controller
          ...
          render={({ field }) => (
            <input
              ...
              className="w-full p-2 text-white bg-transparent border border-gray-400 rounded"
              required
            />
          )}
        />
